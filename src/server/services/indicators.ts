...
import { type ServerContext, now } from "../context.js";

export async function setIndicator(ctx: ServerContext, participantId: string, conversationId: string): Promise<void> {
...
export async function removeIndicator(ctx: ServerContext, participantId: string, conversationId: string): Promise<void> {
